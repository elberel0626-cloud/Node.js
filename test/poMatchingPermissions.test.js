...
test('AP matching can read eligible PO, receipt, and live match-preview data without Purchasing edit permission',()=>{
  ...
  assert.equal(routePermission('POST','/api/ap/po-match-preview'),'AP_BILL_READ');
