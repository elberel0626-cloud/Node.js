...
import { prepareInventoryTraceabilityServer } from './inventoryTraceabilityPatch.js';
...
import { prepareManufacturingAgent3TraceabilityRuntime, patchManufacturingAgent3TraceabilityUiFile } from './manufacturingAgent3TraceabilityPatch.js';
...
await patchManufacturingAgent3ReversalUiFile();
await patchManufacturingAgent3TraceabilityUiFile();
...
const inventoryTraceabilityServerModule = await prepareInventoryTraceabilityServer(financialReportMappingServerModule);
...
await prepareManufacturingAgent3ReversalRuntime();
await prepareManufacturingAgent3TraceabilityRuntime();
const manufacturingServerModule = await prepareManufacturingServer(inventoryTraceabilityServerModule);
