...
export class InvoiceRecognitionService {
  ...
  async processIncomingDocument(documentId){
    ...
    try{
      ...
      if(recognized.extracted){ if(recognized.extracted.documentType==='Vendor Invoice') recognized.extracted.documentType='Bill'; recognized.documentType=recognized.extracted.documentType||recognized.documentType; recognized.extracted.grossInvoiceAmount=Number(recognized.extracted.grossInvoiceAmount||recognized.extracted.totalAmount||0); recognized.extracted.totalAmount=recognized.extracted.grossInvoiceAmount; }
