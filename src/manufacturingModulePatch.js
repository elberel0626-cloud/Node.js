...
export function applyManufacturingModulePatch(source){
  ...
  source=replaceOnceOrAlready(source,'seedInventory();\nfunction adjustInventoryBalance',`seedInventory();\nlet manufacturingRuntime;\nfunction getManufacturingRuntime(){\n if(!manufacturingRuntime)manufacturingRuntime=createManufacturingRuntime({\n  itemMaster,inventoryBalances,inventoryTransactions,inventoryTraceBalances,inventoryTraceTransactions,purchaseOrders,purchaseOrderLines,purchaseReceiptLines,journalEntries,vendors,salesOrders,salesOrderLines,warehouses,inventoryLocations,\n  helpers:{getBalance,qtyAvail,itemCost,adjustInventoryBalance,createInvAudit,createPostedJournal,periodFromDate,validateInventoryAndGlOpen,validatePeriodOpen,requireAccount,calcPoLine,recalcPo,nextPoId,inventoryTrackingMode,normalizeInventoryTraceAllocations,selectInventoryTraceAllocations,applyInventoryTraceReceipt,applyInventoryTraceIssue,inventoryTraceabilityReport}\n });\n return manufacturingRuntime;\n}\nfunction adjustInventoryBalance`,'lazy manufacturing runtime initialization');
