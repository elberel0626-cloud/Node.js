...
const approvalRules = [
  { ruleId: 'APR-0001', ruleName: 'AP Manager approval up to $5,000', active: true, branch: 'Any', department: 'Any', vendorClass: 'Any', vendor: 'Any', amountFrom: 500, amountTo: 5000, approver: 'AP Manager', approverUser: 'ap.manager', backupApprover: 'Controller', backupApproverUser: 'controller', approvalLevel: 1, priority: 10 },
